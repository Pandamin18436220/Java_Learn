...
public class SingletonDemon01 {
    //类的初始化，立即加载这个对象（没有延时加载的优势）,加载类的时候是一个天然的线程安全
    private static SingletonDemon01 instance = new SingletonDemon01();
    private SingletonDemon01(){

    }
    //方法没有同步，调用效率高
    public static SingletonDemon01 getInstance(){
        return instance;
    }
}
